...
**March 2026:** "Parametric Sound Field Interpolation for Scene-based Navigable Immersive Audio" accepted for publication in the *IEEE Transactions on Audio, Speech and Language Processing*. This article presents a parametric sound field interpolation method using multi-point sparse plane wave decomposition to enable perceptually veridical audio rendering for users navigating within immersive volumetric environments.
...
**October 2025:** "Global PIQA: Evaluating Physical Commonsense Reasoning Across 100+ Languages and Cultures" available on arXiv. This work introduces a non-parallel benchmark designed to evaluate physical commonsense reasoning across more than 100 different languages and cultural contexts.
* **Preprint:** [arXiv:2510.24081](https://arxiv.org/abs/2510.24081)
* **Benchmark:** [Hugging Face Dataset](https://huggingface.co/datasets/mrlbenchmarks/global-piqa-nonparallel?s=35)
